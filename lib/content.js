 ...
 * @property {number} width - Native pixel width, used to size the gallery box so the image fills
 *   it without cropping or letterboxing
 * @property {number} height - Native pixel height
 */
...
export const WORKS = [
  {
    ...
    gallery: [
      { src: '/images/path-tracer/cornell-1.webp', caption: 'Cornell box: gold, glass, and diffuse blue.', width: 1080, height: 1080 },
      { src: '/images/path-tracer/angel-balls.webp', caption: 'Reflection and refraction, denoised at 100spp.', width: 1600, height: 900 },
      { src: '/images/path-tracer/gallery-scene.webp', caption: 'A shelf of materials under one light.', width: 1600, height: 900 },
      { src: '/images/path-tracer/cornell-2.webp', caption: 'The same box, softer light, longer glass.', width: 1080, height: 1080 },
      { src: '/images/path-tracer/meleys.webp', caption: "A dragon's head, scales lit from below.", width: 1600, height: 864 },
      { src: '/images/path-tracer/lights.webp', caption: 'Refracting rings, stacked in violet light.', width: 1600, height: 900 },
    ],
  },
  {
    folio: 'II',

...
export const FACTS = [
  { label: 'Now', value: 'Student, building three things at once' },
  { label: 'Comfortable in', value: 'TypeScript, C++, Rust, SQL' },
  { label: 'Interested in', value: 'Rendering, editors, and tools for readers' },
  { label: 'Looking for', value: 'Internship or apprenticeship' },
...
export const THEME_WORDS = [
  { text: 'Rendering' },
  { text: 'Editors', italic: true },
  { text: 'Readers' },
  { text: 'Light', italic: true },
  { text: 'Type' },
  { text: 'Revision', italic: true },
  { text: 'Marginalia' },
  { text: 'Compilers', italic: true },
];

/** @type {string[]} */
export const STACK_WORDS = ['TypeScript', 'C++', 'Rust', 'SQL', 'React', 'Node', 'Tauri', 'BVH', 'Monte Carlo'];
